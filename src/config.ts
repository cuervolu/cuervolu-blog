...
export const LOCALE = {
  ...
  langTag: ["es-CL"], // BCP 47 Language Tags. Set this empty [] to use the environment default
} as const;
...
export const SOCIALS: SocialObjects = [
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/cuervolu",
  ...
  {
    name: "Mail",
    href: "mailto:cuervolu@protonmail.com",
