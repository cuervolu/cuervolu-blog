...
El sitio lo cree con [Astro](https://astro.build/) y [TailwindCSS](https://tailwindcss.com/), específicamente con una template llamada [Astro Micro](https://github.com/trevortylerlee/astro-micro). La mayoría de contenido esta en markdown o MDX, y el sitio es estático, por lo que no hay backend.
